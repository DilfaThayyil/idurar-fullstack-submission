...
const ProjectsTable: React.FC<ProjectsTableProps> = ({ projects, onEdit, onDelete, loading }) => {
              ...
              <tr key={project._id} className="hover:bg-neutral-50 transition-colors">
                <td className="px-6 py-4">
                  <div>
                    ...
                    <div className="text-sm text-neutral-500">ID: {project.projectId}</div>
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end space-x-2">
                    ...
                    <Button size="sm" variant="danger" onClick={() => onDelete(project._id!)}>
                      Delete
                    </Button>
                  </div>
                </td>
