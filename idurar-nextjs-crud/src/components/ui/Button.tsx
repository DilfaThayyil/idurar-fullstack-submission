...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-primary-600 hover:bg-primary-700 text-white focus:ring-primary-500 shadow-soft hover:shadow-medium",
      secondary:
        "bg-secondary-500 hover:bg-secondary-600 text-white focus:ring-secondary-500 shadow-soft hover:shadow-medium",
      outline:
      ...
      danger:
        "bg-error-500 hover:bg-error-600 text-white focus:ring-error-500 shadow-soft hover:shadow-medium"
    };
