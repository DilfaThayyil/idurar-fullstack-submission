    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 mb-8 max-w-3xl mx-auto">
            Streamline your workflow, track progress, and collaborate with your team using our
      ...
      <footer className="bg-neutral-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-neutral-400 mb-4">© 2024 ProjectHub. All rights reserved.</p>
